...
export default function EmployeeApp({ profile, organization, team, instructions, alerts }: Props) {
  ...
  const handleOpenSource = (sourceId: string) => {
    ...
    if (instruction) {
      ...
      setTab('home') // Switch to home tab so modal shows properly
    }
  }
