...
- Org‑isolasjon (alle tenant‑tabeller): verifiser at SELECT/UPDATE/DELETE ikke kan lese/endre rader med org_id fra annen org (organizations, teams, profiles, folders, instructions, instruction_reads, instruction_chunks, alerts, invites, audit_logs, ask_tetrivo_logs, ai_unanswered_questions, gdpr_requests, gdpr_retention_runs).
